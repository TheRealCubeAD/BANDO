...
def erfrageKarte():
    ...
    if artKarte == "Sonderkarte":
        ...
        #elif edition == "Jubiliaeumsedition":
...
#edition = strChoice(["Standardedition"]) # "Jubiliaeumsedition" wird nicht mehr hinzugefügt
...
print()
print()
print("Wird die Variante 'Verdeckter Tipp' oder 'Geheime Vorhersage' gespielt?")
strChoice(["Ja", "Nein"])
print()
print()
print("Wird die Variante 'Hellsehen' gespielt?")
strChoice(["Ja", "Nein"])
print()
print()
#print("Position 1 ist links vom Kartengeber.")
#print("Alle weiteren Positionen werden der Reihen nach im Uhrzeigersinn durchnummeriert.")
#print("An welcher Position sitzen Sie?")
#position = intChoice([ i for i in range(1, anzahlSpieler+1) ])
print()
print()
print("Gefragt wird nach der Karte, die unter dem Stapel liegt.")
